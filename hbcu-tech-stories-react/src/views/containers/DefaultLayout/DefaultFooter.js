...
const DefaultFooter = (props) => {
    return (
        ...
        <footer className="main-footer w3-container w3-padding-32 w3-dark-grey">
            <div className="w3-row-padding">
                <div className="w3-third widget">
                    <h3>FOOTER</h3>
                ...
                <div className="w3-third widget">
                    ...
                    <ul className="w3-ul w3-hoverable">
                        <li className="w3-padding-16">
                            <img src="assets/images/placeholder-300x300.png" className="w3-left w3-margin-right" />
